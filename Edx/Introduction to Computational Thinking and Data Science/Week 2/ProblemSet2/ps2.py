...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        for i in range(width):
            for j in range(height):
                setattr(self,"pos" + str(i) + "_" + str(j), Position(i,j))
    ...
    def cleanTileAtPosition(self, pos):
        ...
        self.Matrix[int(pos.getX())][int(pos.getY())] = 1
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.direction = int(math.floor(random.random()*360))
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        self.angle = int(math.floor(random.random()*360))
        self.setRobotDirection(self.angle)
        new_pos = pos.getNewPosition(self.angle,self.speed)
        if self.room.isPositionInRoom(new_pos) == False:
            self.setRobotDirection(int(math.floor(random.random()*360)))
        else:
